...
while True:
    if criminal == 0 and strange == 0:
        print("\n특이사항 없습니다.\n")
        break
        
    elif criminal == 1 and strange == 0:
        print("공개수배자가 포착되었습니다.")
        print("\n얼굴을 분석하여 범죄자를 특정중입니다.\n")
        if wanted_person == 1:
        ...
        if day >= 5 and day < 10:
            ...
            break
    elif criminal == 1 and strange == 1:
        print("\n공개수배자와 거동수사자가 포착되었습니다.")
